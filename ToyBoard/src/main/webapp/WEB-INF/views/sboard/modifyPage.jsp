			...
			<form role="form" action="modifyPage" method="POST">
				...
				<div class="box box-primary">
					...
					<div class="form-group">
						<label for="exampleInputEmail1">No</label> <input type="text" name='no' class="form-control" value="${boardVO.no}" readonly="readonly">
					</div>
					<div class="form-group">
			...
			<script>
				$(document).ready(function() {
					...
					$(".btn-warning").on("click", function() {
						self.location = "/sboard/list?page=${cri.page}&perPageNum=${cri.perPageNum}&keyword=${keyword}&searchType=${searchType}";
					});
